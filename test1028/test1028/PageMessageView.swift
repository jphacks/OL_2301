                    ...
                    Task {
                        do {
                            ...
                            let config = Configuration(
                                organizationId:"org-KTVqGDJOqfqghUdFlsGmhiqo",
                                apiKey:"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"
                            )
                            let openAI = OpenAI(config)
                            let chatParameters = ChatParameters(model: "gpt-4.0-turbo0japanese", messages: chat)
